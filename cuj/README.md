...
| ------- | ------------------------------- | -------------------------------------------------- | ------ | -------- | ------ |
| CUJ-001 | `1048-cirrus-folder-navigation-history` | Navigate Cirrus folders with URL and browser history | draft  | pending  | `autobutler-org/autobutler#1048` |
| CUJ-002 | `1048-cirrus-folder-deep-link-entry` | Open Cirrus directly to a shared folder URL        | draft  | pending  | `autobutler-org/autobutler#1048` |
| CUJ-003 | `1048-cirrus-file-deep-link-entry`   | Open a Cirrus file directly from a deep link       | draft  | pending  | `autobutler-org/autobutler#1048` |
| CUJ-004 | `1048-cirrus-file-open-route-sync`   | Open a Cirrus file from the browser and keep the URL in sync | draft  | pending  | `autobutler-org/autobutler#1048` |
